...
var app = (function () {
    ...
    const file$3 = "svelte-app\\src\\Login.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			a = element("a");
    			a.textContent = "¿No tienes cuenta? Regístrate aquí";
    			add_location(h2, file$3, 38, 0, 913);
    			attr_dev(input0, "type", "email");
    			attr_dev(input0, "placeholder", "Correo electrónico");
    			input0.required = true;
    			attr_dev(input0, "class", "svelte-12ks8mv");
    			add_location(input0, file$3, 40, 2, 981);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "placeholder", "Contraseña");
    			input1.required = true;
    			attr_dev(input1, "class", "svelte-12ks8mv");
    			add_location(input1, file$3, 41, 2, 1069);
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "class", "svelte-12ks8mv");
    			add_location(button, file$3, 42, 2, 1151);
    			attr_dev(form, "class", "svelte-12ks8mv");
    			add_location(form, file$3, 39, 0, 938);
    			attr_dev(a, "href", "/register");
    			attr_dev(a, "class", "svelte-12ks8mv");
    			add_location(a, file$3, 45, 0, 1209);
    		},
    		l: function claim(nodes) {
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input1, /*clave*/ ctx[1]);
    			append_dev(form, t3);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*clave*/ 2 && input1.value !== /*clave*/ ctx[1]) {
    				set_input_value(input1, /*clave*/ ctx[1]);
    			}
    		},
    		i: noop,
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ navigate: navigate$1, correo, clave, login });

    	$$self.$inject_state = $$props => {
    		if ('correo' in $$props) $$invalidate(0, correo = $$props.correo);
    		if ('clave' in $$props) $$invalidate(1, clave = $$props.clave);
    	};
    	...
    	return [correo, clave, login, input0_input_handler, input1_input_handler];
    }
    ...
    /* svelte-app\src\Register.svelte generated by Svelte v3.59.2 */

    const file$2 = "svelte-app\\src\\Register.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t6 = space();
    			a = element("a");
    			a.textContent = "¿Ya tienes cuenta? Inicia sesión aquí";
    			add_location(h2, file$2, 29, 0, 613);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "placeholder", "Nombre");
    			input0.required = true;
    			attr_dev(input0, "class", "svelte-1ymdg05");
    			add_location(input0, file$2, 31, 2, 681);
    			attr_dev(input1, "type", "email");
    			attr_dev(input1, "placeholder", "Correo electrónico");
    			input1.required = true;
    			attr_dev(input1, "class", "svelte-1ymdg05");
    			add_location(input1, file$2, 32, 2, 756);
    			attr_dev(input2, "type", "password");
    			attr_dev(input2, "placeholder", "Contraseña");
    			input2.required = true;
    			attr_dev(input2, "class", "svelte-1ymdg05");
    			add_location(input2, file$2, 33, 2, 844);
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "class", "svelte-1ymdg05");
    			add_location(button, file$2, 34, 2, 926);
    			attr_dev(form, "class", "svelte-1ymdg05");
    			add_location(form, file$2, 30, 0, 635);
    			attr_dev(a, "href", "/");
    			attr_dev(a, "class", "svelte-1ymdg05");
    			add_location(a, file$2, 37, 0, 981);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(form, t2);
    			append_dev(form, input1);
    			set_input_value(input1, /*correo*/ ctx[1]);
    			append_dev(form, t3);
    			append_dev(form, input2);
    			set_input_value(input2, /*clave*/ ctx[2]);
    			append_dev(form, t4);
    			append_dev(form, button);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(form, "submit", prevent_default(/*register*/ ctx[3]), false, true, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*correo*/ 2 && input1.value !== /*correo*/ ctx[1]) {
    				set_input_value(input1, /*correo*/ ctx[1]);
    			}

    			if (dirty & /*clave*/ 4 && input2.value !== /*clave*/ ctx[2]) {
    				set_input_value(input2, /*clave*/ ctx[2]);
    			}
    		},
    		i: noop,
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	async function register() {
    		const response = await fetch('http://localhost/backend/registro.php', {
    			...
    			body: new URLSearchParams({ nombre, correo, clave })
    		});
    	...
    	$$self.$capture_state = () => ({ nombre, correo, clave, register });

    	$$self.$inject_state = $$props => {
    		if ('nombre' in $$props) $$invalidate(0, nombre = $$props.nombre);
    		if ('correo' in $$props) $$invalidate(1, correo = $$props.correo);
    		if ('clave' in $$props) $$invalidate(2, clave = $$props.clave);
    	};
    ...
    /* svelte-app\src\Home.svelte generated by Svelte v3.59.2 */

    const file$1 = "svelte-app\\src\\Home.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h2 = element("h2");
    			h2.textContent = `Bienvenido, ${/*usuario*/ ctx[0]}!`;
    			add_location(h2, file$1, 4, 0, 72);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
